  ...
  return (
    <>
      <div className="bg-gray-100 min-h-screen font-sans text-gray-800">
        ...
        <Navbar />
        {/* Header */}
        <header className="bg-white/50 text-white p-4 text-center relative h-64 flex items-center justify-center">
          <div className="container mx-auto">
            {/* <h1 className="text-2xl font-light mb-1"></h1> */}
            <h2 className="mb-4 text-3xl font-bold text-black md:text-4xl">
           Proje<span className="gradient-text text-orange-500">ctes</span>
          </h2>
          </div>
        </header>

        {/* Top Cards */}
        <div className="container mx-auto px-4 py-6 grid grid-cols-1 md:grid-cols-3 gap-4 -mt-8 relative z-10 mt-4">
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="p-4 md:w-2/3 flex flex-col md:flex-row">
                ...
                <div className="md:w-1/2 pl-4 mt-4 md:mt-0">
                  ...
                  <Link href={`/properties/${properties[1].id}`}>
                    <button className="bg-orange-600 text-white rounded-md px-4 py-2 mt-4 w-full hover:bg-orange-700">
                      View Details
                    </button>
                  </Link>
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="p-4 md:w-2/3 flex flex-col md:flex-row">
                ...
                <div className="md:w-1/2 pl-4 mt-4 md:mt-0">
                  ...
                  <Link href={`/properties/${properties[2].id}`}>
                    <button className="bg-orange-600 text-white rounded-md px-4 py-2 mt-4 w-full hover:bg-orange-700">
                      View Details
                    </button>
                  </Link>
                  ...
                  <div className="relative h-64 rounded-lg overflow-hidden shadow-md">
                    ...
                    <div className="absolute bottom-0 left-0 bg-gradient-to-t from-black to-transparent w-full p-4">
                      ...
                      <div className="flex mt-2">
                        ...
                        <button className="bg-orange-600 text-white rounded px-3 py-1 text-xs">
                          Contact Developer
                        </button>
                      </div>
                    </div>
          ...
          <div className="mb-6">
            ...
            <div className="flex justify-center space-x-4 mt-6 mb-8">
              <Link href="/commercial">
                <button className="bg-orange-600 text-white px-6 py-3 rounded-lg hover:bg-orange-700 transition-all">
                  Explore Commercial Properties
                </button>
              </Link>
              <Link href="/residential">
                <button className="border border-orange-600 text-orange-600 px-6 py-3 rounded-lg hover:bg-orange-50 transition-all">
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="p-4 md:w-2/3 flex flex-col md:flex-row">
                ...
                <div className="md:w-1/2 pl-4 mt-4 md:mt-0">
                  ...
                  <Link href={`/properties/${properties[3].id}`}>
                    <button className="bg-orange-600 text-white rounded-md px-4 py-2 mt-4 w-full hover:bg-orange-700">
                      View Details
                    </button>
                  </Link>
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="p-4 md:w-2/3 flex flex-col md:flex-row">
                ...
                <div className="md:w-1/2 pl-4 mt-4 md:mt-0">
                  ...
                  <Link href={`/properties/${properties[4].id}`}>
                    <button className="bg-orange-600 text-white rounded-md px-4 py-2 mt-4 w-full hover:bg-orange-700">
                      View Details
                    </button>
                  </Link>
